...
--  @req FR-PH-02, FR-PH-03, FR-PD-06, FR-SF-02, FR-SF-05, FR-SF-07, FR-UI-02
...
--  id:2.2/f7e55cc1bdfa8583/Press_Ped/1/0/
   ...
   --  phase_sequencer.ads:47:4:Press_Ped
--  end read only
...
--  id:2.2/3a0ae308cafa95fc/Set_Left_Demand/1/0/
   ...
   --  phase_sequencer.ads:52:4:Set_Left_Demand
--  end read only
...
--  id:2.2/4ff9bed62f797aee/Set_Fault/1/0/
   ...
   --  phase_sequencer.ads:59:4:Set_Fault
--  end read only
...
--  id:2.2/6b8f4b2871edaf07/Reset_Controller/1/0/
   ...
   --  phase_sequencer.ads:64:4:Reset_Controller
--  end read only
...
--  id:2.2/a21b50bb7db1b650/Invariant_Holds/1/0/
   ...
   --  phase_sequencer.ads:73:4:Invariant_Holds
--  end read only
