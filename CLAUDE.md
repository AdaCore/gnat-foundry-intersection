...
alr -n exec -- gprbuild -P obj/host/gnattest/harness/test_driver.gpr -cargs:Ada -gnat2022
...
- **`developer`** — implements features and fixes compile errors /
  ...
  harness (`obj/host/gnattest/harness/test_runner`). Hands off SPARK,
...
4. ~~Replace hand-rolled `tests/unit/test_runner.adb` with AUnit or gnattest.~~
   ...
   `obj/host/gnattest/harness/test_runner`. Stubs for `cmd_input` /
