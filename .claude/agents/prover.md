---
name: prover
description: Keep the SPARK Silver proof targets proven after a change. Use for the Prove task of the feature workflow — discharges gnatprove obligations on types/core via contracts, invariants, and ghost code. Oracle: `make prove`.
...
`make prove`; you are done **only** when it exits 0 with no unproved checks.
