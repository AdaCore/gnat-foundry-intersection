---
name: test-generator
description: Generate the unit-test harness and bodies for new/changed code. Use for the Test generation task of the feature workflow — runs gnattest and fills AUnit test bodies under tests/. Oracle: `make generate-tests && make build-native && make test`.
...
oracle is `make generate-tests && make build-native && make test`; you
