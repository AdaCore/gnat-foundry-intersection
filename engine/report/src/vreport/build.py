...
# with colon-fence admonitions and inline attributes, the furo theme, and the
# rst2pdf builder for the optional PDF rendering.
...
# `attrs_inline`: the rendered CONOPS anchors each of its leaves on an inline
# span, so a run of leaves stays the one list its author wrote.
